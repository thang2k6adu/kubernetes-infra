...
linux
./seal-env.ps1 <ENV_FILE> <CONFIGMAP_NAME> <SECRET_NAME> <NAMESPACE> <CERT_PATH>

VD
chmod +x seal-env.sh
cd cluster-dev/tenants/pp191225-api-service
../../../../scripts/seal-env.sh pp191225-api pp191225-config pp191225-secret ~/sealed-secrets/pub-cert.pem
cd ../../..
...
..\..\..\scripts\seal-env.ps1 pp191225-api pp191225-config pp191225-secret ~\sealed-secrets\pub-cert.pem
cd ../../..
